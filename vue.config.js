...
module.exports = {
  ...
  //   // eg: 更改编译忽略某些svg文件的加载
    config.module.rule('svg').exclude.add(resolve('src/components/SvgIcon')).end()
    config.module.rule('icons').test(/\.svg$/).include.add(resolve('src/components/SvgIcon')).end().use('svg-sprite-loader').loader('svg-sprite-loader').options({ symbolId: 'icon-[name]' }).end()
